...
@protocol YLReadTrackingSliderDelegate;
@protocol YLReadTrackingSliderDataSource;

@interface YLReadTrackingSlider : UISlider
...
@property (weak, nonatomic) id<YLReadTrackingSliderDataSource> dataSource;

// delegate is only needed when used with a TableView or CollectionView - see below
@property (weak, nonatomic) id<YLReadTrackingSliderDelegate> delegate;
@end
...
@protocol YLReadTrackingSliderDataSource <NSObject>
