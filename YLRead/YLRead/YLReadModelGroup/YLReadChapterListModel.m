...
- (NSDictionary *)dictionaryRepresentation
{
    ...
    [mutableDict setValue:[NSNumber numberWithDouble:self.id] forKey:kYLReadChapterListModelId];
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    self.id = [aDecoder decodeDoubleForKey:kYLReadChapterListModelId];
...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeDouble:_id forKey:kYLReadChapterListModelId];
